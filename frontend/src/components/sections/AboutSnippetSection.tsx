...
import { ArrowRight, CheckCircle2, ShieldCheck, Zap, Compass, Code2 } from "lucide-react";
    ...
    <section className="py-20 bg-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Right Column: Trust & Commitment Card */}
          <div className="lg:col-span-5 relative">
            <div className="rounded-3xl bg-white border border-slate-200 p-8 space-y-6 shadow-xl relative">
