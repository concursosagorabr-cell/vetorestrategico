        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {steps.map((item, idx) => {
            ...
            return (
              <div
                key={item.step}
                className="relative rounded-3xl bg-white border border-slate-200 p-8 flex flex-col justify-between hover:border-slate-300 shadow-sm hover:shadow-md transition-all duration-300 group hover:-translate-y-1"
              >
